...
| :-: | :-: | :- | :-: | :-: | :-: |
|1-2 Subsistemas|1-2|**Un brillante destello... y nada mas:** Gana un pico menor. Si utiliza la regla especial de movimiento silencioso, el valor de Señal regrasa al valor normal en su lugar.|0|No|No|
||3-4|**Fuego:** Inflige l punto adicional de Daño en el casco en cada fase de inicio de ronda, antes de tirar Control de daños.|0|Yes|No|
||5-6|**Fuga de energía:** la nave no puede utilizar órdenes especiales.|2|Yes|Yes|
|3-4 Casco|1-2|**Éscaner desactivado:** El atributo de escáner se reduce a 1 .|0|Yes|No|
||3-4|**Armadura agrietada:** El valor de Armadura sufre un modificador de un +2 para el resto de la partida.|2|No|No|
...
| :-: | :-: | :- | :-: | :-: | :-: |
|1-2 Subsistemas|1-2|**Un brillante destello... y nada mas:** Gana un pico menor. Si utiliza la regla especial de movimiento silencioso, el valor de Señal regrasa al valor normal en su lugar.|0|No|No|
||3-4|**Fallo de contención atmosférica:** Inflige 2 puntos de daño adicionales en el Casco en cada fase de final de ronda, antes de tirar control de daños.|0|Yes - 2 requeridos|No|
||5-6|**Fluctuación de energía:** Sufre 1d3 de puntos de daño en Casco si realiza ordenes especiales. Si utiliza Movimiento silencioso, la Señal vuelve a su valor normal. No puede activar Movimiento silencioso.|0|Yes|No|
|3-4 Casco|1-2|**Daño en los escáneres:** El valor de Escáner se reduce a 6 .|0|Yes|No|
